                ...
                >
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    {canManageMembers && !isOwnerRow && !isSelf ? (
                      ...
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-[var(--radius-medium)] border px-2.5 py-1 text-xs font-medium ${roleMeta.className}`}
                      >
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`inline-flex items-center gap-1 rounded-[var(--radius-medium)] border px-2 py-0.5 text-[11px] font-medium ${inviteRoleMeta.className}`}
                          >
